...
var Watcher = function () {
  function Watcher(instance, key) {
    (0, _classCallCheck3.default)(this, Watcher);

    var w = this;
    var data = instance[key];
  ...
  (0, _createClass3.default)(Watcher, [{
    ...
    value: function on(fn) {
      ...
      this.subs.push(fn);
      return function () {
        _this.subs = _this.subs.filter(function (f) {
          return f !== fn;
        });
      };
    }
    ...
    value: function notify() {
      ...
      this.subs.forEach(function (fn) {
        fn.call(_this2.instance, _this2.value, _this2.oldValue, function () {
          _this2.off(fn);
        });
      });
      this.parents.forEach(function (watchObj) {
        watchObj.notify();
      });
    }
  }]);
...
var Data = function () {
  function Data(config) {
    ...
    var initConfig = (0, _assign2.default)(dataDefault(), config);
    (0, _assign2.default)(this, initConfig);

    (0, _keys2.default)(initConfig).map(function (propertyName) {
      new _Watcher2.default(_this, propertyName);
    });
  }
  ...
  (0, _createClass3.default)(Data, [{
    ...
    value: function watch(obj) {
      ...
      (0, _keys2.default)(obj).map(function (name) {
        var watch = _this2.$watchs[name];
        if (watch) {
          watch.on(obj[name].bind(_this2));
        }
      });
    }
  }]);
...
$export($export.P + $export.R, 'Set', {toJSON: __webpack_require__(56)('Set')});
